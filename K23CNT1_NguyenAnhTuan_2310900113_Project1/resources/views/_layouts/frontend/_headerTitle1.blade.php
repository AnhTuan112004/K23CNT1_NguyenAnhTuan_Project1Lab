  ...
  <div class="header bg-gradient-to-r from-purple-500 to-pink-500">
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          <a class="mr-4 hover:underline" href="{{ route('natuser.home1') }}">Trang Chủ</a>
        ...
        <div class="flex items-center space-x-4">
          ...
          <a class="hover:underline" href="nat-user/support">
              <i class="fas fa-question-circle"></i> Hỗ Trợ
          </a>
          <a class="hover:underline" href="#"><i class="fas fa-globe"></i> Tiếng Việt</a>
          <a class="flex items-center space-x-1" href="{{ route('natuser.tt.natedit', ['id' => Session::get('user_id')]) }}"> 
          ...
          @if(Session::has('username1'))
              <a class="hover:underline" href="{{ route('natuser.home') }}">
                  Đăng Xuất
              </a>
          @else
              <a class="hover:underline" href="{{ route('natuser.login') }}">
                  Đăng Nhập
              </a>
          @endif
        </div>
      ...
      <div class="flex items-center py-4">
        ...
        <div class="flex-grow mx-4">
          <form action="{{ route('natuser.search1') }}" method="GET" class="flex">
