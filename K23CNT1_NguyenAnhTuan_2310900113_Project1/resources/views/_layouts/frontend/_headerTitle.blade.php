    ...
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          ...
          <a class="mr-4 hover:underline" href="{{route('natuser.home')}}">Trang Chủ</a>
        ...
        <div>
          ...
          <a class="mr-4 hover:underline" href="nat-user/support">
              <i class="fas fa-question-circle"></i> Hỗ Trợ
            </a>
          <a class="mr-4 hover:underline" href="#"><i class="fas fa-globe"></i> Tiếng Việt</a>
          <a class="mr-4 hover:underline" href="{{route('natuser.natsignup')}}">Đăng Ký</a>
          <a class="hover:underline" href="{{route('natuser.login')}}">Đăng Nhập</a>
        </div>
      </div>
      <!-- Main Navigation -->
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('natuser.home')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logoD.jpg" width="40"/></a>
          <span class="text-2xl font-bold">PHONESTORE</span>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('natuser.search')}}" method="GET" class="flex">
