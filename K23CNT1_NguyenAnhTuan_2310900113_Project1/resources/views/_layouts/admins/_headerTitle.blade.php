...
<header class="bg-dark text-white p-3">
    <div class="container d-flex justify-content-between align-items-center">
        <!-- Logo -->
        <div class="logo">
            <a href="/nat-admins" class="text-white text-decoration-none">
        ...
        <!-- Menu Navigation -->
        <!-- Search form -->
        <form action="{{ route('natuser.searchAdmins') }}" method="GET" class="search-form">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('natuser.home')}}" class="text-white text-decoration-none" style="font-size: 14px;">Đăng xuất</a>
        </div>
    </div>
</header>
